...
export const en: Dictionary = {
  ...
  auth: {
    ...
    loginSub:
      "Sign in to keep your own card portfolio — browsing and search work without an account.",
    registerTitle: "Create account",
    registerHeading: "Create an account",
    registerSub:
      "An account only ties a portfolio to you. Every price on the site stays free to browse without one.",
    email: "Email",
  ...
  portfolio: {
    ...
    description:
      "Every card you own in one place, with its current value and your profit or loss against what you paid.",
    heading: "My portfolio",
    sub: "Track the cards you actually own and see what they are worth today against what you paid for them.",
    empty: "Your portfolio is empty",
    emptySub: 'Open any card page and hit "Add to portfolio" to start.',
    emptyCta: "Find cards",
    statValue: "Current value",
    statCost: "Total cost",
    statGain: "Profit / loss",
    statCards: "Cards held",
    noCostYet: "Needs both a cost and a current price",
    colCard: "Card",
    colCondition: "Condition",
    colQty: "Qty",
    colCost: "Cost each",
    colPrice: "Latest price each",
    colValue: "Value",
    colActions: "",
    remove: "Remove",
    save: "Save",
    missingCard: "This card is no longer in the database",
    noPrice: "No price yet",
    addTitle: "Add to portfolio",
    addSub: "Saved to your own portfolio — nobody else can see it.",
    condition: "Condition",
    quantity: "Quantity",
    cost: "Price paid, per card (THB)",
    costHint: "Optional, but profit and loss needs it",
    note: "Note",
    noteHint: "Where you bought it, where you keep it",
    add: "Add to portfolio",
    added: "Added to your portfolio",
    removed: "Removed from your portfolio",
    updated: "Saved",
    loginToAdd: "Sign in to keep this card in your portfolio",
    viewPortfolio: "View my portfolio",
    guestNote:
      "Prices and search are open to everyone — an account is only for keeping a portfolio.",
  },
