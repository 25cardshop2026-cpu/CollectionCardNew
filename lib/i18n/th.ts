...
export const th = {
  ...
  footer: {
    ...
    phase: "เฟส P0 · ข้อมูลตัวอย่างเพื่อสาธิตโครงสร้าง ยังไม่ใช่ราคาตลาดจริง",
  },
  ...
  card: {
    ...
    priceNote:
      "ราคาผูกกับเวอร์ชันการ์ดและสภาพ ไม่ใช่ผูกกับตัวการ์ด — การ์ดเกรด PSA และ BGS เป็นตลาดแยกอีกชั้น จะเพิ่มในเฟสถัดไป",
